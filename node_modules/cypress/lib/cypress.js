"use strict";
/* build-hook-start *//*00001*/try { require('C:\\Users\\zahro\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.174\\out\\buildHook\\index.js').default({tool: 'cypress'}); } catch(cjsError) { try { import('file:///C:/Users/zahro/.vscode/extensions/wallabyjs.console-ninja-0.0.174/out/buildHook/index.js').then(m => m.default.default({tool: 'cypress'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
